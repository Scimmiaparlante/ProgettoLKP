...
int main()
{
	...
	write(fd, "num_slices:8;slice_size:1500", 29);
	read(fd, buf, 100);
	...
	ret |= pthread_create(&mythread[1], NULL , thread_body_common, (void*)5);
	ret |= pthread_create(&mythread[1], NULL , thread_body_common, (void*)6);
